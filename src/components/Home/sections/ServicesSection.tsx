  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        {/* Section Header */}
        <div className={`text-center mb-12 md:mb-16 max-w-3xl mx-auto ${isRTL ? '' : ''}`}>
        ...
        <div 
          ...
          className={`relative mb-12 flex flex-nowrap !gap-20 overflow-visible ${isRTL ? 'flex-row' : 'flex-row'}`}
          style={{
            width: '100%',
        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <ul className="space-y-2 mb-5">
                <li className={`flex items-start gap-2 text-[#A0AEC0] text-xs ${isRTL ? 'flex-row' : 'flex-row'}`}>
              ...
              <div className={`flex items-baseline mb-4 pt-4 border-t border-white/10 ${isRTL ? 'justify-between' : 'justify-between flex-row-reverse'}`}>
                <span className="text-[#A0AEC0] text-xs">{t('services.pricing.from')}</span>
                <span className="text-2xl font-extrabold bg-gradient-to-r from-[#00D9FF] to-[#6C5CE7] bg-clip-text text-transparent">$300</span>
              </div>
              <div className="space-y-2">
                <button className={`w-full py-3 bg-transparent border-2 border-[#00D9FF] text-[#00D9FF] rounded-lg text-sm font-semibold transition-all hover:bg-gradient-to-r hover:from-[#00D9FF] hover:to-[#6C5CE7] hover:text-white hover:shadow-[0_0_20px_rgba(0,217,255,0.4)] flex items-center justify-center gap-2 ${isRTL ? 'flex-row' : 'flex-row-reverse'}`}>
                  <span>{t('services.cta.quote')}</span>
                </button>
                <Link
                  to="https://websitemy.com/"
                  className={`w-full py-2.5 flex items-center justify-center gap-2 text-[#A0AEC0] hover:text-[#00D9FF] text-xs font-medium transition-all group ${isRTL ? 'flex-row' : 'flex-row-reverse'}`}
                >
                  <ExternalLink className={`w-3.5 h-3.5 transition-transform ${isRTL ? 'group-hover:translate-x-[-2px]' : 'group-hover:translate-x-[2px]'}`} />
          ...
          <div 
            ...
            style={{ minWidth: '280px', willChange: 'transform, opacity' }}
          >
            <div className={`absolute top-3 bg-gradient-to-r from-[#00D9FF] to-[#6C5CE7] text-white px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider shadow-[0_0_15px_rgba(0,217,255,0.4)] ${isRTL ? 'left-3' : 'right-3'}`}>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className={`flex items-baseline mb-4 pt-4 border-t border-white/10 ${isRTL ? 'justify-between' : 'justify-between flex-row-reverse'}`}>
                <span className="text-[#A0AEC0] text-xs">{t('services.pricing.free')}</span>
