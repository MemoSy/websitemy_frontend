    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          ...
          } bg-[#0F1729]/95 backdrop-blur-xl border border-cyan-500/30 rounded-lg shadow-[0_8px_32px_rgba(0,217,255,0.2)] overflow-hidden z-50 min-w-[120px] animate-fade-in`}
        >
          {Object.keys(languages).map((lng) => (
            <button
              ...
              } hover:bg-cyan-500/10 transition-all duration-200 flex items-center ${
                isRTL ? "flex-row-reverse" : "flex-row"
