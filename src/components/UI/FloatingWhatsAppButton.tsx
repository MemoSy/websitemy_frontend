...
const FloatingWhatsAppButton = () => {
  ...
  className="group fixed bottom-[90px] md:bottom-[120px] left-4 md:left-8 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 via-green-500 to-teal-500 px-4 text-white shadow-[0_18px_45px_-15px_rgba(16,185,129,0.8)] transition-all duration-300 hover:shadow-[0_20px_55px_-18px_rgba(16,185,129,0.95)]"
    >
