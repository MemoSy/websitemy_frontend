...
export const aiProjects: AIProjectKnowledge[] = [
  {
    ...
    name: "آلاء المصري — منصة التمكين المهني",
    aliases: ["آلاء المصري", "alaa almasri", "منصة آلاء المصري", "تمكين مهني", "براندينج", "هوية قيادية"],
    category: "informational",
    type: "منصة بناء هوية قيادية وتمكين مهني",
    url: "https://www.alaaalmasri.com",
    price: "$700",
    duration: "6 أسابيع",
    teamSize: "2 مطورين (Full-Stack + UI/UX)",
    rating: "4.9",
    client: "الأستاذة آلاء المصري — خبيرة تسويق وتمكين مهني",
    technologies: [
      "Next.js 16",
      "React 19",
      "TypeScript",
    ...
    features: [
      "محرر بصري مدمج (Inline Visual CMS) لتعديل المحتوى من الواجهة الحية",
      "مسارات تدريبية متخصصة للأفراد والمؤسسات مع دعوات تسجيل سريعة",
      "منظومة متكاملة لجمع وتوليد العملاء المحتملين (Lead Generation Funnel)",
      "مشغل فيديو مخصص يدعم مقاطع YouTube Shorts الرأسية بدقة 9:16",
      "تكامل فوري مع مجتمع WhatsApp عبر أزرار وبطاقات عائمة ذكية",
      "سرعة فائقة بنظام كاش ذكي Tag Invalidation وتحميل في أقل من ثانية",
    ],
    result: "+40% زيادة في تحويل الزوار لمجتمع واتساب وسرعة 98+ على Google PageSpeed واستقلالية تامة في إدارة المحتوى",
    keywords: ["آلاء المصري", "تمكين", "مهني", "لينكدإن", "واتساب", "محرر بصري", "Next.js 16", "مقالات", "كورسات"],
  },
  {
    id: "akkkr-real-estate",
    name: "عَقَارُك — منصة عقارية ذكية",
    aliases: ["عقارك", "عقارك العقارية", "منصة عقارك", "akkkr", "akkkr real estate", "منصة عقارية", "تطبيق عقارات"],
    category: "saas",
    type: "منصة إدارة وتسويق عقاري مع مساعد ذكاء اصطناعي",
    url: "https://akkkr.vercel.app",
    price: "$800",
    duration: "6 أسابيع",
    teamSize: "مطور Full-Stack متقدم واحد",
    rating: "4.9",
    client: "شركات الوساطة والتطوير العقاري، ومكاتب إدارة الأملاك",
    technologies: [
      "Next.js 16",
      "React 19",
      "Node.js 22",
    ...
    features: [
      "عرض وتصفح عقاري متطور مقسم حسب (بيع، إيجار، رهن، مراهنة)",
      "محرك فلترة وبحث متقدم بالسعر والمساحة والغرف والمواقع والقرى",
      "مساعد محادثة ذكي تفاعلي لإدارة المفاوضات واستخراج متطلبات الزوار",
      "نظام متابعة المفاوضات عبر روابط فريدة مشفرة ومؤمنة",
      "لوحة تحكم إدارية شاملة لإضافة وتعديل العقارات وإدارة القرى",
      "رفع مباشر للميديا والفيديوهات الكبيرة سحابياً عبر Vercel Blob Presigned URLs",
      "نظام حماية أمني متعدد الطبقات مع التحكم الذري في الجلسات sessionVersion",
      "نظام توثيق إلكتروني لكوكي الزائر وحظر العروض المريبة",
    ],
    result: "أتمتة المفاوضات العقارية وتصفية طلبات العملاء بالذكاء الاصطناعي مع لوحة تحكم سريعة وعالية الأمان",
    keywords: ["عقار", "عقارات", "عقارك", "مفاوضات", "ذكاء اصطناعي", "وساطة", "فلترة", "أملاك", "شقق", "أراضي", "Next.js 16", "Akkkr"],
  },
  {
    id: "arabia-swim",
  ...
  },
  {
    ...
    url: "https://memo-flow.vercel.app/ar",
    price: "$1,500",
    teamSize: "2 مطورين",
    rating: "4.6",
