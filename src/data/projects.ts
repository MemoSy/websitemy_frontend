...
export const getProjects = (): Project[] => {
...

  {
    ...
    title: "سوريا 2030",
    description:
      "منصة تفاعلية تتيح للسوريين مشاركة رؤاهم لمستقبل بلدهم عبر خريطة تفاعلية متعددة المستويات.",
    fullDescription:
      "بناء منصة تفاعلية تتيح للسوريين (في الداخل والخارج) مشاركة رؤاهم لمستقبل بلدهم عبر خريطة تفاعلية متعددة المستويات. الهدف الأساسي هو جمع أكبر عدد ممكن من الرؤى، مع التركيز على الدقة الجغرافية التقريبية والتصميم المخصص للموبايل أولاً. المنصة تدعم 8 فئات رئيسية (التعليم، الصحة، البنية التحتية، الإسكان، الاقتصاد، الثقافة، الرياضة، والمجتمع) وتتضمن ميزات مثل التحديث اللحظي، المشاركة المجهولة، والإعلانات الحكومية.",
    ...
    aiData: {
      ...
      teamSize: "مبرمج واحد",
      keyFeatures: [
        "خريطة تفاعلية باستخدام Leaflet لعرض الرؤى الجغرافية",
        "نظام رؤى زمني (تختفي الرؤى بعد فترة مع إمكانية التمديد)",
        "8 فئات رئيسية للرؤى (تعليم، صحة، إلخ)",
        "نظام تعليقات وتفاعل لحظي باستخدام Socket.io",
        "مشاركة مجهولة وتحديد الموقع الجغرافي",
        "لوحة إدارة للمسؤولين مع رفع الصور",
        "نظام إعلانات حكومية وشارات للمسؤولين",
        "تصميم متجاوب للموبايل أولاً مع تأثيرات Glassmorphism"
      ],
      clientFeedback: "منصة مبتكرة تساهم في بناء رؤية مشتركة لمستقبل سوريا",
    },
    reviews: [],
    liveUrl: "https://syria-2030.vercel.app",
    githubUrl: "#",
    objectives: [
      "جمع أكبر عدد ممكن من الرؤى حول مستقبل سوريا",
      "تمكين المواطنين من المشاركة في بناء رؤية مشتركة",
      "توفير منصة آمنة للتعبير عن الآراء مع خيار الخصوصية",
      "ربط السوريين في الداخل والخارج عبر خريطة تفاعلية",
      "دعم الجهات الحكومية في التواصل مع الشعب"
    ],
    challenges: [
      "تطوير خريطة تفاعلية دقيقة جغرافياً مع الحفاظ على الأداء",
      "إدارة المحتوى الكبير والتفاعلات اللحظية",
      "ضمان الأمان والخصوصية في المشاركات المجهولة",
      "دمج ميزات متقدمة مثل النظام الزمني والإعلانات الحكومية",
      "تحسين الأداء للموبايل مع بيانات كبيرة"
    ],
    features: [
      "خريطة تفاعلية مع 8 فئات ملونة (تعليم، صحة، إلخ)",
      "نظام تسجيل ومصادقة مع JWT وتحديد المدينة الأصلية",
      "إنشاء ومشاركة الرؤى مع إمكانية التعليق والتصويت",
      "نظام زمني للرؤى (تختفي بعد 24 ساعة مع تمديد ممكن)",
      "لوحة إدارة للمسؤولين مع رفع الصور والإحصائيات",
      "نظام إعلانات حكومية مع شارات للمسؤولين",
      "فلتر زمني لاستكشاف التطور التاريخي",
      "تحميل ذكي للمناطق (Viewport Loading) لتحسين الأداء",
      "دعم اللغة العربية فقط مع RTL",
      "تكامل مع Google Generative AI للمساعدة في إنشاء المحتوى",
      "نظام إشعارات وتحديثات لحظية",
      "إمكانية رفع الصور للأماكن والمشاركات"
    ],
  },
];
};
